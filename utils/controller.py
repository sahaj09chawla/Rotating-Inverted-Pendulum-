...
class BalanceController:
    def __init__(self, controller_config: ControllerConfig):
        ...
        self.pid = PID(kp=controller_config.kp, ki=controller_config.ki, kd=controller_config.kd, output_limit=controller_config.output_limit,  derivative_filter=controller_config.derivative_filter)
